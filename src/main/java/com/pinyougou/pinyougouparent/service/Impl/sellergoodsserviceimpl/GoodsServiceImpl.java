...
import com.pinyougou.pinyougouparent.mapper.*;
import com.pinyougou.pinyougouparent.pojo.*;
...
public class GoodsServiceImpl implements GoodsService {
	...
	public void add(Goods goods) {
		...
		goods.getGoodsDesc().setGoodsId(goods.getGoods().getId());//将商品基本表的ID给商品描述表
	...
	public void update(Goods goods){
		...
		com.pinyougou.pinyougouparent.pojo.TbItemExample.Criteria criteria=example.createCriteria();
